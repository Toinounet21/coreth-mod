...
go build -ldflags "-X github.com/Toinounet21/coreth-mod/plugin/evm.GitCommit=$coreth_commit -X github.com/Toinounet21/coreth-mod/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
