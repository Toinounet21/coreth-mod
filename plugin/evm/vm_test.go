...
import (
	...
	"github.com/Toinounet21/coreth-mod/trie"
	...
	"github.com/Toinounet21/avalanchego-mod/chains/atomic"
	...
	engCommon "github.com/Toinounet21/avalanchego-mod/snow/engine/common"
	...
	"github.com/Toinounet21/coreth-mod/eth"
	"github.com/Toinounet21/coreth-mod/params"
	"github.com/Toinounet21/coreth-mod/rpc"

	accountKeystore "github.com/Toinounet21/coreth-mod/accounts/keystore"
)
...
func TestRepairAtomicRepositoryForBonusBlockTxs(t *testing.T) {
	...
	vm.atomicTxRepository.Write(canonical, []*Tx{tx})
	vm.atomicTxRepository.Write(bonus1, []*Tx{tx})
	vm.atomicTxRepository.Write(bonus2, []*Tx{tx})
	vm.db.Commit()
	...
	err = vm.repairAtomicRepositoryForBonusBlockTxs(
		allHeights,
	...
	for _, height := range allHeights {
		txs, err := vm.atomicTxRepository.GetByHeight(height)
		if err != nil {
			t.Fatal(err)
		}
		assert.Len(t, txs, 1)
