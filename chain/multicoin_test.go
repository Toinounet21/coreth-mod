...
import (
	...
	"github.com/Toinounet21/coreth-mod/accounts/keystore"
...
func TestMulticoin(t *testing.T) {
	...
	//}
	//counterSrc, err := filepath.Abs(gopath + "/src/github.com/Toinounet21/coreth-mod/examples/multicoin/mc_test.sol")
	//if err != nil {
	// 	t.Fatal(err)
	// }
